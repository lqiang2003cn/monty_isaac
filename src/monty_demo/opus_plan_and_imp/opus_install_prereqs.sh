...
# opus_plan_and_imp is at src/monty_demo/opus_plan_and_imp; repo root is two levels up from monty_demo
...
echo "Prerequisites done. Build with: source /opt/ros/jazzy/setup.bash && colcon build --packages-select monty_demo && source install/setup.bash"
